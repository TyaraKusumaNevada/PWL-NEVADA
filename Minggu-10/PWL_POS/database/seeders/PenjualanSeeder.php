    ...
    public function run(): void
    {
        $data = [
            ...
            [
                ...
                'penjualan_tanggal' => '2025-02-02 10:00:00',
            ],
            [
                'user_id'           => 3,
                'pembeli'           => 'Yusuf Maulana',
                'penjualan_kode'    => 'TR003',
                'penjualan_tanggal' => '2025-02-03 10:00:00',
            ],
            [
                'user_id'           => 1,
                'pembeli'           => 'Melati Ayu',
                'penjualan_kode'    => 'TR004',
                'penjualan_tanggal' => '2025-02-04 10:00:00',
            ],
            [
                'user_id'           => 3,
                'pembeli'           => 'Bagus Fajar',
                'penjualan_kode'    => 'TR005',
                'penjualan_tanggal' => '2025-02-05 10:00:00',
            ],
            [
                'user_id'           => 1,
                'pembeli'           => 'Lita Maharani',
                'penjualan_kode'    => 'TR006',
                'penjualan_tanggal' => '2025-02-06 10:00:00',
            ],
            [
                'user_id'           => 3,
                'pembeli'           => 'Rizky Ramadhan',
                'penjualan_kode'    => 'TR007',
                'penjualan_tanggal' => '2025-02-07 10:00:00',
            ],
            [
                'user_id'           => 3,
                'pembeli'           => 'Sherly Putri',
                'penjualan_kode'    => 'TR008',
                'penjualan_tanggal' => '2025-02-08 10:00:00',
            ],
            [
                'user_id'           => 3,
                'pembeli'           => 'Galih Dwi',
                'penjualan_kode'    => 'TR009',
                'penjualan_tanggal' => '2025-02-09 10:00:00',
            ],
            [
                'user_id'           => 3,
                'pembeli'           => 'Budiono Siregar',
                'penjualan_kode'    => 'TR010',
                'penjualan_tanggal' => '2025-02-10 10:00:00',
            ],
        ];
